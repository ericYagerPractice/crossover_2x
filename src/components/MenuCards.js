...
export default function MenuCards() {
    return(
        <>
          <MDBCol md='6' xl='3' className=''>
            <MDBAnimation reveal type='fadeInLeft'>
              <MDBCard cascade className='context-card my-2 px-3 py-2 border-dark rounded-3 hover-zoom d-flex flex-column'>
                <MDBCardTitle className="context-card__title my-1 d-flex d-flex flex-row align-items-center">
                  <img
                    className="d-block mr-2 card-icon"
                    src={cardIcon1}
                    alt="Icon 1"
                  />
                  <div className="context-card__title-interior">
                    <span className="d-block">Challenge Pod</span>
                    <span className="d-block">Pick ur Channel</span>
                  </div>
                </MDBCardTitle>
                <MDBCardBody cascade className='mt-3 p-0 text-left dark-text'>
                  <hr className="w-75 my-0 ml-0 mr-auto text-left border-danger"/>
